...
import com.android.weathertestapp.di.component.DaggerFragmentComponent
import com.android.weathertestapp.di.component.FragmentComponent
...
abstract class BaseMvpFragment : Fragment(), BaseView {
    ...
    override fun showError(messageResource: Int, messageStyle: Int) {
        if (activity != null) {
            activity!!.showError(messageResource, messageStyle)
        }
    }
}
